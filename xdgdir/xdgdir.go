...
// directories.  Don't create your own; use the package variables.
type Dir struct {
...
// InvalidDirError is returned when Open or Create are called on a Dir
// that doesn't have a valid path set.
type InvalidDirError struct {
	// Method called (either "open" or "create")
	Op string
	// Environment variable name
	Env string
	// Name of the file given as an argument
	Name string
}
